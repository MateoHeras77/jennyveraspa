  ...
  return (
    <div className="bg-[#FDFBF7] min-h-screen text-[#1B1B1B] overflow-hidden">
      ...
      <section className="relative h-screen w-full flex items-center justify-center overflow-hidden">
        {/* Background Elements */}
        <div className="absolute inset-0 bg-[#F5F2EB] z-0">
          <div className="absolute inset-0 opacity-10 bg-[url('/noise.svg')]"></div> {/* Texture placeholder */}
          <motion.div 
            style={{ y: y1, rotate: -5 }}
            className="absolute top-[-10%] right-[-5%] w-[500px] h-[500px] rounded-full bg-[#D4AF37]/5 blur-[100px]" 
          />
          <motion.div 
            style={{ y: y2, rotate: 10 }}
            className="absolute bottom-[-10%] left-[-10%] w-[600px] h-[600px] rounded-full bg-[#D4AF37]/10 blur-[120px]" 
          />
        </div>
        ...
        <div className="container relative z-10 px-6 mx-auto text-center">
          ...
          <motion.h1 
            ...
            className="font-serif text-5xl md:text-7xl lg:text-8xl font-medium tracking-tight text-[#1B1B1B] mb-6"
          >
            Jenny Vera <br/>
            <span className="italic text-[#D4AF37]">Spa</span>
          </motion.h1>
          ...
          <motion.p 
            ...
            className="text-lg md:text-xl font-light text-gray-600 max-w-2xl mx-auto mb-10 leading-relaxed"
          >
            Un santuario de bienestar en Cuenca donde la ciencia se encuentra con el lujo.
            Personalizamos cada tratamiento para revelar tu belleza natural.
          </motion.p>
          ...
          >
            <Link
              href="/contacto"
              className="bg-[#1B1B1B] text-white hover:bg-[#D4AF37] rounded-full px-8 py-6 text-sm tracking-widest uppercase transition-all duration-300 shadow-xl shadow-black/5"
            >
              Reservar Cita
            </Link>
            <Link
              href="/servicios"
              className="border border-[#1B1B1B]/20 text-[#1B1B1B] hover:bg-[#F5F2EB] rounded-full px-8 py-6 text-sm tracking-widest uppercase"
            >
              Ver Rituales
            </Link>
          </motion.div>
        ...
        >
          ...
          <span className="text-[10px] tracking-[0.3em] text-[#D4AF37] uppercase">Descubre</span>
        </motion.div>
      </section>

...
- **El paquete de mapas no se combate con código.** `best massage near me` lleva 3 mediciones en posición 5,7-6,6 con CERO clics. Cuando el título está bien y la posición es buena y el CTR es cero, la palanca es el GBP (`docs/fase-1-gbp-y-resenas.md`), no el repo.
